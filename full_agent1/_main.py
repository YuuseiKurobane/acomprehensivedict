"""Command-line orchestrator for the full Agent 1 dictionary pipeline."""
...
DEFAULT_TAG_MAP = WORK_DIR.parent / "acomprehensive_tags_map.csv"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    layer1 = subparsers.add_parser("layer1", help="PDF -> Layer 1 intermediates")
    ...
    all_command = subparsers.add_parser("all", help="run Layer 1 then Layer 2")
...
def run_layer2_command(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return build_yomitan(
        ...
        tag_map_path=args.tag_map,
        dictionary_name=args.name or f"AComprehensive_agent1_{args.profile}",
