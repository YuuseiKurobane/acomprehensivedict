Users: go to `yomitan/` folder n then download the zip. then import to yomitan.

Developers: you can read this if you want to tweak the yomitan dict.
...
- `audit1_line_wrap_resolutions.csv` — reviewed ambiguous-wrap decisions. WARNING: generated by AI.
